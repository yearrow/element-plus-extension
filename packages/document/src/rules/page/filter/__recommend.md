...
- 多行过滤器布局方式使用grid24栏响应式布局；grid中的每一列gutter都使用10px的间距
### 样式
- 无
### 规范
...
<image src="./单行过滤器.png" style="width:60%" ></image>
...
<image src="./多行过滤器.png" style="width:60%" ></image>

#### 混合使用

情景一、多行过滤器功能按钮都放在功能条中

<image src="./情景1.png" style="width:60%" ></image>

情景二、单行过滤器加少量功能按钮

<image src="./情景2.png" style="width:60%" ></image>
...
<image src="./情景4.png"  style="width:60%"></image>
...
<image src="./panel过滤器.png"  style="width:60%"></image>
